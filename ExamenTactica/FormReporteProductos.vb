...
Public Class FormReporteProductos
    ...
    Private Sub ButtonGenerarReporteProducto_Click(sender As Object, e As EventArgs)
        Try
            Dim idProducto As Integer
            If Not Integer.TryParse(TextBoxIngresarIdProducto.Text.Trim(), idProducto) Then
                MessageBox.Show("Por favor ingrese un ID de producto valido.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Return
            End If

            ' Obtener reporte desde la BLL
            Dim dt As DataTable = productoBLL.ObtenerReporteMensualProducto(idProducto)

            If dt Is Nothing OrElse dt.Rows.Count = 0 Then
                MessageBox.Show("No se encontraron ventas mensuales para ese producto.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Return
            End If
